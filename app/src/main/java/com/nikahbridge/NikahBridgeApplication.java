 ...
 * for Global Community Chat, the real rewarded-message flow, and Premium Upgrade.
 *
...
public class NikahBridgeApplication extends Application implements Application.ActivityLifecycleCallbacks {
    ...
    @Override public void onActivityResumed(Activity activity){initializePrivacyConsent(activity);addBack(activity);addCommunityEntry(activity);addRewardEntry(activity);addPremiumEntry(activity);}
