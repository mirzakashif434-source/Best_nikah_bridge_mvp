...
public class FutureLifeSimulationActivity extends Activity {
    ...
    private void render(){
        ...
        result=txt("Your real comparison result will appear here after Azure AI responds.",15,false);root.addView(result);
