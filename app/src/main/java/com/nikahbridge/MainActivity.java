...
public class MainActivity extends Activity {
    ...
    private void showHome() {
        ...
        Button profile =
                appButton("Create / Edit Profile");

        Button matches =
                appButton("Recommended Matches");

        Button interests =
                appButton("My Interests");

        Button safety =
                outlineButton("Safety & Privacy");

        Button help =
                outlineButton("Help & Nikah Guidance");
        ...
        Button delete =
                outlineButton("Delete Local Profile");
        ...
        root.addView(
                subtitle(
                        "A serious Muslim matrimonial platform " +
                                "for respectful Nikah connections.\n" +
                                "No dating • Privacy first • Mutual " +
                                "connection before safe communication."
                )
        );
        ...
        note.setText(
                "Production note: account authentication, " +
                        "cloud profiles, verification, moderation " +
                        "and real chat require the secure backend."
        );
    ...
    private void showCreateProfile() {
        ...
        Spinner intention =
                addSpinner(intentions);

        String[] practice = {
                "Select religious practice",
                "Practicing Muslim",
                "Moderately practicing",
                "Prefer not to say"
        };

        Spinner practiceSpinner =
                addSpinner(practice);

        EditText about = new EditText(this);

        about.setHint(
                "About yourself, family values " +
        ...
        preference.setHint(
                "Preferred age, country/city, values " +
                        "and other important preferences"
        );
        ...
        verify.setText(
                "Verification status: Not verified.\n\n" +
                        "Verification must be completed through " +
                        "the secure platform/admin process.\n\n" +
                        "Never share passwords, OTPs or private " +
                        "documents in chat."
        );
        ...
        save.setOnClickListener(v -> {
            ...
            if (intention.getSelectedItemPosition() == 0) {

                Toast.makeText(
                        this,
                        "Please select marriage intention.",
                        Toast.LENGTH_SHORT
                ).show();
            ...
            if (practiceSpinner.getSelectedItemPosition() == 0) {
                ...
                Toast.makeText(
                        this,
                        "Please select religious practice.",
                        Toast.LENGTH_SHORT
                ).show();
    ...
    private void showMatches() {
        ...
        root.addView(
                subtitle(
                        "These are sample profiles for " +
                                "the current local build.\n" +
                                "They are NOT real verified users."
                )
        );
        ...
        addMatchCard(
                ...
                "Pakistan",
                "Sample",
                "Serious Nikah • Family-oriented",
                "Sample profile for interface testing. " +
                        "Real profiles must come from the secure backend."
        );
    ...
    private void addMatchCard(
        ...
        if (blockedProfiles.contains(name)) {
            return;
        }
        ...
        interest.setOnClickListener(v -> {
            ...
            Toast.makeText(
                    ...
                    "Interest saved locally. " +
                            "Real mutual connection requires " +
        ...
        report.setOnClickListener(v -> {
            ...
            Toast.makeText(
                    this,
                    name +
                            " has been blocked locally. " +
                            "Production reporting requires the backend.",
                    Toast.LENGTH_LONG
            ).show();
    ...
    private void showProfileDetails(
        ...
        profile.setText(
                "Country: " +
                        ...
                        "Verification: Not verified in " +
                        "this local sample build.\n\n" +

                        "Safety: Contact details should " +
                        "remain private until a genuine " +
                        "mutual connection."
        );
        ...
        chat.setOnClickListener(
                v -> Toast.makeText(
                        this,
                        "Safe Chat is locked. " +
                                "A real backend must verify " +
                                "mutual acceptance first.",
                        Toast.LENGTH_LONG
                ).show()
        );
    ...
    private void showInterests() {
            ...
            root.addView(
                    subtitle(
                            "No interests sent yet.\n" +
                                    "Your connections should remain " +
        ...
        note.setText(
                "These interests are currently stored " +
                        "only during this app session. " +
                        "Production interests must be stored " +
    ...
    private void showSafety() {
        ...
        root.addView(
                subtitle(
                        "Best Nikah Bridge is designed " +
                                "for serious matrimonial connections."
                )
        );
        ...
        safety.setText(
                "✓ Never share your password or OTP.\n\n" +
                        ...
                        "✓ Keep phone number and contact " +
                        "details private.\n\n" +

                        "✓ Use Express Interest before " +
                        "communication.\n\n" +

                        "✓ Safe Chat should be available " +
                        "only after mutual acceptance.\n\n" +

                        "✓ Report or block suspicious or " +
                        "disrespectful profiles.\n\n" +

                        "✓ Genuine verification must be " +
                        "handled securely by the platform/admin.\n\n" +

                        "✓ This local client does not claim " +
                        "to provide real identity verification.\n\n" +

                        "✓ Real authentication, backend security, " +
                        "moderation and server-side authorization " +
    ...
    private void showHelp() {
        ...
        root.addView(
                subtitle(
                        "Simple guidance for a respectful " +
                                "Muslim marriage journey."
                )
        );
        ...
        help.setText(
                "1. Complete your profile honestly.\n\n" +
                        ...
                        "3. Review compatibility and " +
                        "profile information.\n\n" +

                        "4. Express Interest respectfully.\n\n" +

                        "5. Wait for mutual acceptance " +
                        "before chat.\n\n" +

                        "6. Report/block anything unsafe " +
                        "or inappropriate.\n\n" +

                        "7. For religious questions, seek " +
                        "guidance from a trusted qualified scholar.\n\n" +

                        "8. Never send money, passwords, OTPs " +
                        "or private documents to another user."
        );
    ...
    private void confirmLocalDelete() {
        ...
        root.addView(
                subtitle(
                        "This removes the profile information " +
        ...
        warning.setText(
                "Important:\n\n" +
                        "This local build does not have a " +
                        "server account. Therefore this button " +
                        "only clears local profile data.\n\n" +
                        "A production version must provide a " +
                        "complete account deletion process that " +
                        "also removes server-side account/data."
        );

        warning.setTextSize(16);
        warning.setTextColor(dark);
