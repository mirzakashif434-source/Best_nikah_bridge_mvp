...
/** Production bilingual Welcome. Azure External ID is the only active account path. */
public class WelcomeActivity extends Activity {
    ...
    private void showWelcome(){
        ...
        TextView start=hit("GET STARTED / آغاز کریں"),login=hit("SIGN IN / لاگ اِن کریں"),lang=hit("English / اردو");
    ...
    private void showLanguageDialog(){new AlertDialog.Builder(this).setTitle("Language / زبان").setSingleChoiceItems(new String[]{"English","اردو"},0,(d,w)->d.dismiss()).setNegativeButton("Cancel",null).show();}
