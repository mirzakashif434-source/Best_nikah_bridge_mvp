...
public class HelpLineAdminActivity extends Activity {
    ...
    private void text(String s,boolean bold){TextView t=new TextView(this);t.setText(s);t.setTextSize(bold?18:15);t.setTextColor(Premium2030Ui.TEXT);t.setPadding(dp(8),dp(10),dp(8),dp(10));if(bold)t.setTypeface(android.graphics.Typeface.DEFAULT,android.graphics.Typeface.BOLD);root.addView(t);}
